...
# Generated clock (16MHz via a PLL from the 24MHz)
create_generated_clock -source {pll_1|altpll_component|pll|inclk[0]} -divide_by 3 -multiply_by 2 -duty_cycle 50.00 -name clock_16 {pll_1|altpll_component|pll|clk[0]}

# Generated clock (32MHz via a PLL from the 24MHz)
create_generated_clock -source {pll_1|altpll_component|pll|inclk[0]} -divide_by 3 -multiply_by 4 -duty_cycle 50.00 -name clock_32 {pll_1|altpll_component|pll|clk[1]}

# Generated clock (25MHz via a PLL from the 50MHz)
create_generated_clock -source {pll_2|altpll_component|pll|inclk[0]} -divide_by 4 -multiply_by 2 -duty_cycle 50.00 -name clock_25 {pll_2|altpll_component|pll|clk[0]}
...
set_output_delay -clock clock_16 -min   0.0 -source_latency_included [get_ports SRAM_ADDR*]
set_output_delay -clock clock_16 -min   0.0 -source_latency_included [get_ports SRAM_OE_N]
set_input_delay  -clock clock_16 -min   0.0 -source_latency_included [get_ports SRAM_DQ*]
...
set_output_delay -clock clock_16 -max  25.75 -source_latency_included [get_ports SRAM_ADDR*]
set_output_delay -clock clock_16 -max  25.75 -source_latency_included [get_ports SRAM_OE_N]
...
set_input_delay  -clock clock_16 -max  22.75 -source_latency_included [get_ports SRAM_DQ*]
...
# 25.75 means the xilinx output delay (x) should be > (31.25-25.75) i.e. > 5.5ns
set_output_delay -clock clock_16 -min 25.75 -source_latency_included [get_ports SRAM_WE_N]
...
set_output_delay -clock clock_16 -max 25.25 -source_latency_included [get_ports SRAM_WE_N]
...
set_output_delay -clock clock_16 -min 0     -source_latency_included [get_ports SRAM_DQ*]
set_output_delay -clock clock_16 -max 25.25 -source_latency_included [get_ports SRAM_DQ*]

# In practice:
# - path from ext_nWE was 5.807ns
# - path from clock_16 was 6.792ns
...
#set_input_delay -min -clock clock_16    0.0 [get_ports FL_DQ]
#set_input_delay -max -clock clock_16    0.0 [get_ports FL_DQ]

# Asynchronous, so don't bother constraining:

#set_input_delay -min -clock clock_16    0.0 [get_ports SW]
#set_input_delay -max -clock clock_16    0.0 [get_ports SW]
#set_input_delay -min -clock clock_16    0.0 [get_ports KEY]
#set_input_delay -max -clock clock_16    0.0 [get_ports KEY]
#set_input_delay -min -clock clock_16    0.0 [get_ports UART_RXD]
#set_input_delay -max -clock clock_16    0.0 [get_ports UART_RXD]

# More complex, so don't bother constraining:

#set_input_delay -min -clock clock_16    0.0 [get_ports PS2_CLK]
#set_input_delay -max -clock clock_16    0.0 [get_ports PS2_CLK]
#set_input_delay -min -clock clock_16    0.0 [get_ports PS2_DAT]
#set_input_delay -max -clock clock_16    0.0 [get_ports PS2_DAT]
#set_input_delay -min -clock clock_16    0.0 [get_ports I2C_SCLK]
#set_input_delay -max -clock clock_16    0.0 [get_ports I2C_SCLK]
#set_input_delay -min -clock clock_16    0.0 [get_ports I2C_SDAT]
#set_input_delay -max -clock clock_16    0.0 [get_ports I2C_SDAT]
#set_input_delay -min -clock clock_16    0.0 [get_ports SD_MISO]
#set_input_delay -max -clock clock_16    0.0 [get_ports SD_MISO]
...
set_output_delay -clock clock_16 -min 0   [get_ports I2C_SCLK]
set_output_delay -clock clock_16 -max 0   [get_ports I2C_SCLK]
set_output_delay -clock clock_16 -min 0   [get_ports I2C_SDAT]
set_output_delay -clock clock_16 -max 0   [get_ports I2C_SDAT]
set_output_delay -clock clock_16 -min 0   [get_ports AUD_XCK]
set_output_delay -clock clock_16 -max 0   [get_ports AUD_XCK]
set_output_delay -clock clock_16 -min 0   [get_ports AUD_BCLK]
set_output_delay -clock clock_16 -max 0   [get_ports AUD_BCLK]
set_output_delay -clock clock_16 -min 0   [get_ports AUD_ADCLRCK]
set_output_delay -clock clock_16 -max 0   [get_ports AUD_ADCLRCK]
set_output_delay -clock clock_16 -min 0   [get_ports AUD_DACLRCK]
set_output_delay -clock clock_16 -max 0   [get_ports AUD_DACLRCK]
set_output_delay -clock clock_16 -min 0   [get_ports AUD_DACDAT]
set_output_delay -clock clock_16 -max 0   [get_ports AUD_DACDAT]
...
#set_output_delay -clock clock_16 -min 0   [get_ports HEX*]
#set_output_delay -clock clock_16 -max 0   [get_ports HEX*]
#set_output_delay -clock clock_16 -min 0   [get_ports LED*]
#set_output_delay -clock clock_16 -max 0   [get_ports LED*]
#set_output_delay -clock clock_16 -min 0   [get_ports VGA*]
#set_output_delay -clock clock_16 -max 0   [get_ports VGA*]
...
set_clock_groups -asynchronous -group {clock_32}  -group {clock_25}
set_clock_groups -asynchronous -group {clock_25}  -group {clock_32}

set_clock_groups -asynchronous -group {clock_16}  -group {clock_25}
set_clock_groups -asynchronous -group {clock_25}  -group {clock_16}
