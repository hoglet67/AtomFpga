...
create_generated_clock -name clock_icet65  -source [get_ports {sys_clk}]   -master_clock sys_clk   -divide_by 27 -multiply_by  24 [get_nets {clock_icet65  }]
...
// Ignore any timing paths between the main and ICET65 clock domains
set_clock_groups -asynchronous -group [get_clocks {clock_main}]   -group [get_clocks {clock_icet65}]
set_clock_groups -asynchronous -group [get_clocks {clock_icet65}] -group [get_clocks {clock_main}]
...
set_multicycle_path -from [get_regs {inst_AtomFpga_Core/cpu/*/*inst*65*/*}] -to [get_regs {inst_AtomFpga_Core/cpu/*/*inst*65*/*}]  -setup -end 4
set_multicycle_path -from [get_regs {inst_AtomFpga_Core/cpu/*/*inst*65*/*}] -to [get_regs {inst_AtomFpga_Core/cpu/*/*inst*65*/*}]  -hold  -end 3
